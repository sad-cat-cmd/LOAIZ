...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QuickStudioCsvTableModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QuickStudioCsvTableModel_t qt_meta_stringdata_QuickStudioCsvTableModel = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QuickStudioCsvTableModel[] = {
...
Q_CONSTINIT const QMetaObject QuickStudioCsvTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_QuickStudioCsvTableModel.offsetsAndSizes,
