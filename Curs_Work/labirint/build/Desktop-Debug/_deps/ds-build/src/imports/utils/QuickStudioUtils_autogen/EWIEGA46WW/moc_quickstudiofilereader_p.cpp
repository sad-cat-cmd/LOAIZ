...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QuickStudioFileReader_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QuickStudioFileReader_t qt_meta_stringdata_QuickStudioFileReader = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_QuickStudioFileReader[] = {
...
Q_CONSTINIT const QMetaObject QuickStudioFileReader::staticMetaObject = { {
    ...
    qt_meta_stringdata_QuickStudioFileReader.offsetsAndSizes,
